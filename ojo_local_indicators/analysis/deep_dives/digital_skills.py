...
# ojo_local_indicators_config = get_yaml_config(Path(str(PROJECT_DIR) + "/ojo_local_indicators/config/base.yaml"))
...
PATH_TO_SUSSEX_DATA = (
    "/Users/cathsleeman/Desktop/Data/Sussex/sussex_07-06-2021_22-11-2021.json"
)
